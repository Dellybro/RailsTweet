class User < ActiveRecord::Base
  ...
  def s3_credentials
    {:url => ":s3_domain_url", :region => 'us-west-2', :s3_host_name => 's3-us-west-2.amazonaws.com/twitterclone-assets-users', :bucket =>'twitterclone-assets-users', :access_key_id=>'AKIAI3HYSXZDOT5TNUUA', :secret_access_key=>'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'}
  end
